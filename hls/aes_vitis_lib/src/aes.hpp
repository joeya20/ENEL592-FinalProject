...
class aesEnc<256> : public aesTable {
   public:
    ...
    void updateKey(ap_uint<256> cipherkey) {
        ...
        updateKey_label0:for (ap_uint<5> iter = 2; iter < 15; iter += 2) {
    ...
    void process(ap_uint<128> plaintext, ap_uint<256> cipherkey, ap_uint<128>& ciphertext) {
        ...
        for (round_counter = 1; round_counter <= 14; round_counter++) {
            // SubByte
            process_label1:for (int i = 0; i < 16; i++) {
            ...
            // MixColumn
            process_label2:for (int i = 0; i < 16; i++) {
            ...
            if (round_counter < 14) {
                process_label3:for (int i = 0; i < 4; i++) {
    ...
    void updateKey_2(ap_uint<256> cipherkey) {
        ...
        updateKey_2_label4:for (ap_uint<5> iter = 2; iter < 15; iter++) {
